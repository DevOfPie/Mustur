...
below 5c is built.** Until 2026-09-10 this paragraph said neither was merged,
...
**Since 5c, and discharging no milestone above.** Work has continued past the
last row and none of it belongs to a milestone this file names, so it is listed
here rather than left to make the table read as the whole of what is built: the
...
[MUS-W-0022](records/work-units/MUS-W-0022.md), 2026-09-04 to 2026-09-07);
...
[MUS-D-0150](records/decisions.md#mus-d-0150), 2026-09-07); the tmux server in a
...
channel, rather than the pane — is
...
the evidence it turns on. The row is deliberately absent until that is answered.
