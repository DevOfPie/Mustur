...
- 2026-08-24 (whippy) — `docs/ui-surfaces.md` has now had three surfaces built the way it exists to prevent, each after the last was recorded, and the owner has answered the same question twice (MUS-Q-0010, MUS-Q-0034). The record is demonstrably not the safeguard. Whatever would be one is not another paragraph in that file
